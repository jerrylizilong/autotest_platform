...
insert into `test_keyword` (`id`, `keyword`, `paraCount`, `template`, `elementTemplate`, `example`, `description`, `status`) values('29','验证标题','1','extend.extend().assert_title(driver,"$para1")',NULL,'验证标题|百度地图','验证页面的title中是否包含预期文字','1');
insert into `test_keyword` (`id`, `keyword`, `paraCount`, `template`, `elementTemplate`, `example`, `description`, `status`) values('30','Chrome','1','Chrome',NULL,'Chrome','初始化Chrome 浏览器','1');
insert into `test_keyword` (`id`, `keyword`, `paraCount`, `template`, `elementTemplate`, `example`, `description`, `status`) values('30','公共方法','1','	$para1',NULL,'公共方法|游客登录','调用公共方法','1');
